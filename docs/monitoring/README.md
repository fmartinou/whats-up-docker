...
# HELP WUD_CONTROLLER_total The number of watched containers
# TYPE WUD_CONTROLLER_total gauge
WUD_CONTROLLER_total{type="docker",name="local"} 6
```
