Feature: WUD Container API Exposure
  ...
  Scenario Outline: WUD must allow to get all containers
    ...
    Examples:
      ...
      | 3     | ghcr_radarr              | ghcr     | https://ghcr.io/v2                                      | linuxserver/radarr                  | 3.2.1.5070-ls105   | 4.3.2.6857-ls165   | true            |
      ...
      | 16    | hub_vaultwarden_1222     | hub      | https://registry-1.docker.io/v2                         | vaultwarden/server                  | 1.28.0-alpine      | 1.28.0-alpine      | false           |
      ...
      | 19    | lscr_radarr              | lscr     | https://lscr.io/v2                                      | linuxserver/radarr                  | 3.2.1.5070-ls105   |4.3.2.6857-ls165    | true            |
  ...
  Scenario: WUD must allow to get a container with digest
    ...
    And response body path $.result.digest should be sha256:bfb112db4075460ec042ce13e0b9c3ebd982f93ae0be155496d050bb70006750
    And response body path $.updateAvailable should be true
