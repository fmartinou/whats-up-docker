Feature: WUD Container API Exposure
    ...
    And response body path $ should be of type array with length 16
  ...
  Scenario Outline: WUD must allow to get all containers
    ...
    Examples:
      ...
      | 7     | hub_omnidb_latest        | hub      | https://registry-1.docker.io/v2                         | omnidbteam/omnidb            | latest        | latest        | false           |
