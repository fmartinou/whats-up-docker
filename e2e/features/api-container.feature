Feature: WUD Container API Exposure
  ...
  Scenario Outline: WUD must allow to get all containers
    ...
    Examples:
      ...
      | 4     | hub_homeassistant_202161 | hub      | https://registry-1.docker.io/v2                         | homeassistant/home-assistant | 2021.6.1         | 2022.7.5        | true            |
      | 5     | hub_homeassistant_latest | hub      | https://registry-1.docker.io/v2                         | homeassistant/home-assistant | latest           | latest           | false           |
      | 6     | hub_nginx_120            | hub      | https://registry-1.docker.io/v2                         | library/nginx                | 1.20-alpine      | 1.23-alpine      | true            |
      ...
      | 12    | hub_traefik_245          | hub      | https://registry-1.docker.io/v2                         | library/traefik              | 2.4.5            | 2.8.1            | true            |
      | 13    | hub_traefik_latest       | hub      | https://registry-1.docker.io/v2                         | library/traefik              | latest           | latest           | false           |
      | 14    | hub_vaultwarden_1222     | hub      | https://registry-1.docker.io/v2                         | vaultwarden/server           | 1.25.1-alpine    | 1.25.1-alpine    | false           |
      ...
      | 17    | lscr_radarr              | lscr     | https://lscr.io/v2                                      | linuxserver/radarr           | 3.2.1.5070-ls105 |4.1.0.6175-ls146 | true            |
  ...
  Scenario: WUD must allow to get a container with digest
    ...
    And response body path $.result.digest should be sha256:186c79dc14ab93e43d315143ee4b0774506dc4fd952388c20e35d3d37058ab8d
    And response body path $.updateAvailable should be true
  ...
  Scenario: WUD must allow to get a container with its link
    ...
    And response body path $.result.link should be https://github.com/home-assistant/core/releases/tag/2022.7.5
