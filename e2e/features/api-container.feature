Feature: WUD Container API Exposure
  ...
  Scenario Outline: WUD must allow to get all containers
    ...
    Examples:
      ...
      | 3     | ghcr_radarr              | ghcr     | https://ghcr.io/v2                                      | linuxserver/radarr                  | 3.2.1.5070-ls105   | 5.9.1.9070-ls236   | true            |
      | 4     | gitlab_test              | gitlab   | https://registry.gitlab.com/v2                          | manfred-martin/docker-registry-test | 1.0.0              | 2.0.0              | true            |
      | 5     | hub_homeassistant_202161 | hub      | https://registry-1.docker.io/v2                         | homeassistant/home-assistant        | 2021.6.1           | 2024.9.1           | true            |
      ...
      | 13    | hub_traefik_245          | hub      | https://registry-1.docker.io/v2                         | library/traefik                     | 2.4.5              | 3.1.2              | true            |
      ...
      | 18    | lscr_radarr              | lscr     | https://lscr.io/v2                                      | linuxserver/radarr                  | 3.2.1.5070-ls105   |5.9.1.9070-ls236    | true            |
  ...
  Scenario: WUD must allow to get a container with digest
    ...
    And response body path $.result.digest should be sha256:88a0a069d5e9865fcaaf8c1e53ba6bf3d8d987b0fdc5e0135fec8ce8567d673e
    And response body path $.updateAvailable should be true
  ...
  Scenario: WUD must allow to get a container with its link
    ...
    And response body path $.result.link should be https://github.com/home-assistant/core/releases/tag/2024.9.1
