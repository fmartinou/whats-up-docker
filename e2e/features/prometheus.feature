Feature: Prometheus exposure
  ...
  Scenario Outline: WUD must expose watched containers
    ...
    Examples:
      ...
      | ghcr_radarr              | ghcr     | https://ghcr.io/v2                                      | linuxserver/radarr           | 3.2.1.5070-ls105 |3.2.2.5080-ls129 | true            |
      ...
      | hub_vaultwarden_1222     | hub      | https://registry-1.docker.io/v2                         | vaultwarden/server           | 1.23.1-alpine    | 1.23.1-alpine    | false           |
      ...
      | lscr_radarr              | lscr     | https://lscr.io/v2                                      | linuxserver/radarr           | 3.2.1.5070-ls105 |3.2.2.5080-ls129 | true            |
      | quay_prometheus          | quay     | https://quay.io/v2                                      | prometheus/prometheus        | v2.30.0          |v2.32.1          | true            |