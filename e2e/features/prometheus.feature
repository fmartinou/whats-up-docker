Feature: Prometheus exposure
  ...
  Scenario Outline: WUD must expose watched containers
    ...
    Examples:
      ...
      | ghcr_radarr              | ghcr     | https://ghcr.io/v2                                      | linuxserver/radarr                  | 3.2.1.5070-ls105   |4.3.2.6857-ls162    | true            |
      ...
      | lscr_radarr              | lscr     | https://lscr.io/v2                                      | linuxserver/radarr                  | 3.2.1.5070-ls105   |4.3.2.6857-ls162    | true            |
